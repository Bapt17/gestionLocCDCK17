...
Client::Client(unsigned int id, const QString &nom, const QString &prenom,
               const QDate &dateNaissance, const QString &genre,
               const QString &codePostal)
    : m_id(id), m_nom(nom), m_prenom(prenom), m_dateNaissance(dateNaissance),
      m_genre(genre), m_codePostal(codePostal) {}
