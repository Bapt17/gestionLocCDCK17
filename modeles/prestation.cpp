...
Prestation::Prestation(QObject *parent, unsigned int id, const QString &nom,
                       const QString &type, float tarifAdulte, float tarifU12,
                       float tarifU8)
    : QObject(parent), m_id(id), m_nom(nom), m_type(type),
      m_tarifAdulte(tarifAdulte), m_tarifU12(tarifU12), m_tarifU8(tarifU8) {}
...
void Prestation::setTarifAdulte(float tarif) { m_tarifAdulte = tarif; }

float Prestation::getTarifU12() const { return m_tarifU12; }
void Prestation::setTarifU12(float tarif) { m_tarifU12 = tarif; }

float Prestation::getTarifU8() const { return m_tarifU8; }
void Prestation::setTarifU8(float tarif) { m_tarifU8 = tarif; }
